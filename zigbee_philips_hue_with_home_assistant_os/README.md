...
5. Click **Next** and search for **Bootloader – SoC Internal Storage bootloader**.
   ![](image/Example_Project_Selection.png)
...
4. Click the **Create Helper** button in the bottom-right corner.
   ![](image/Create_Helper_button.png)
