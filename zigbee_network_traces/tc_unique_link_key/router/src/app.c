...
//                                Static Variables
// -----------------------------------------------------------------------------
static sl_zigbee_af_event_t router_info_event_control; // Custom event control

// -----------------------------------------------------------------------------
//                          Static Function Declarations
// -----------------------------------------------------------------------------
static void router_info_event_handler(sl_zigbee_af_event_t *event);
...
{
  sl_zigbee_af_event_init(&router_info_event_control,
                          router_info_event_handler);
}
                                               ...
                                               uint8_t finalState)
{
  sl_zigbee_app_debug_println("%s network %s: 0x%02X",
                              ...
                              "complete",
                              status);
  sl_zigbee_af_event_set_active(&router_info_event_control);
}
 ...
 */
void network_join_handler(sl_cli_command_arg_t *arguments)
{
  // Launch the join process
  sl_status_t sc;
  sc = sl_zigbee_af_network_steering_start();
